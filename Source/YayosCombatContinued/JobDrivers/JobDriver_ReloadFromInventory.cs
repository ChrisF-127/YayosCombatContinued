...
namespace YayosCombatContinued
{
	internal class JobDriver_ReloadFromInventory : JobDriver
	{
		...
		public override IEnumerable<Toil> MakeNewToils()
		{
			...
			yield return JobUtility.DropCarriedThing();
			yield return next;
			...
			yield return JobUtility.EquipStaticOrTargetA();
			yield return Wait;
			yield return JobUtility.ReloadFromCarriedThing();
			yield return StowCarriedAmmoAndReaddToQueue();
			yield return Toils_Jump.Jump(repeat);
			yield return done;
			yield return JobUtility.EquipStaticOrTargetA(primary);
		}
